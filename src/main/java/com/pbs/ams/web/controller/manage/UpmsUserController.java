...
public class UpmsUserController extends BaseController {
    ...
    public String organization(@PathVariable("id") long id, ModelMap modelMap) { // int id, long id
        // 所有组织
    ...
    public String role(@PathVariable("id") long id, ModelMap modelMap) { // int id, long id
        // 所有角色
    ...
    public String permission(@PathVariable("id") long id, ModelMap modelMap) { // int id, long id
    ...
    public String update(@PathVariable("id") long id, ModelMap modelMap) { // int id, long id
        UpmsUser user = upmsUserService.selectByPrimaryKey(id);
        modelMap.put("user", user);
    ...
    @ResponseBody
    public Object update(@PathVariable("id") long id, UpmsUser upmsUser) { // int id, long id
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsUser.getUsername(), new LengthValidator(1, 20, "帐号"))
                .on(upmsUser.getRealname(), new NotNullValidator("姓名"))
                .doValidate()
