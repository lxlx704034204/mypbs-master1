...
public class UpmsPermissionController extends BaseController {
    ...
    public Object list(
            ...
            @RequestParam(required = false, defaultValue = "0", value = "systemId") long systemId,  // long systemId, int systemId
    ...
    @ResponseBody
    public Object role(@PathVariable("id") long id) {  // long id, int id
    ...
    @ResponseBody
    public Object user(@PathVariable("id") long id, HttpServletRequest request) { // long id, int id
    ...
    public String update(@PathVariable("id") long id, ModelMap modelMap) {// long id, int id
        UpmsSystemExample upmsSystemExample = new UpmsSystemExample();
        upmsSystemExample.createCriteria()
                .andStatusEqualTo((byte) 1);
        List<UpmsSystem> upmsSystems = upmsSystemService.selectByExample(upmsSystemExample);
    ...
    @ResponseBody
    public Object update(@PathVariable("id") long id, UpmsPermission upmsPermission) {// long id, int id
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsPermission.getName(), new LengthValidator(1, 20, "名称"))
                .doValidate()
                .result(ResultCollectors.toComplex());
