...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public Mapper mapper; // 需要ApplicationContextListener.java 来进行注入！

	@Override
	public long countByExample(Example example) { // int
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
			Method countByExample = mapper.getClass().getDeclaredMethod("countByExample", example.getClass());
			Object result = countByExample.invoke(mapper, example);
			return Long.parseLong(String.valueOf(result));//Integer.parseInt(String.valueOf(result));
	...
	@Override
	public int deleteByPrimaryKey(Long id) { //Integer id
		try {
			DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
	...
	public List<Record> selectByExample(Example example) {
		try {
			System.out.println("----test-1-selectByExample(...)--mapper-: " + mapper); //
			System.out.println("----test-2-selectByExample(...)--SLAVE.getName()-: " + DataSourceEnum.SLAVE.getName()); //
			DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
			System.out.println("----test-3-selectByExample(...)--mapper-: " + mapper); //
	...
	@Override
	public Record selectByPrimaryKey(Long id) {  //Integer id
		try {
			System.out.println("----test-1-selectByPrimaryKey(...)--mapper-: " + mapper); //
			System.out.println("----test-2-selectByPrimaryKey(...)--SLAVE.getName()-: " + DataSourceEnum.SLAVE.getName()); //
//			DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
			System.out.println("----test-3-selectByPrimaryKey(...)--mapper-: " + mapper); //
	...
	@Override
	public void initMapper() {	//ApplicationContextListener
		System.out.println("----test-1-initMapper()--getMapperClass()-: "+ getMapperClass() ); //
		System.out.println("----test-2-initMapper()--this.mapper-: "+ SpringContextUtil.getBean(getMapperClass()) ); //
